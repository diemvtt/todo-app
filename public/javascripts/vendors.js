...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"index","1":"serverSide"}[chunkId]||chunkId) + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newTodoForm = __webpack_require__(158);
	...
	var _todoItem = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewTodoForm = (function (_React$Component) {
	    ...
	    function NewTodoForm() {
	        ...
	        _get(Object.getPrototypeOf(NewTodoForm.prototype), 'constructor', this).call(this);
	    }
	    ...
	    _createClass(NewTodoForm, [{
	        ...
	        value: function handleSubmit(e) {
	            e.preventDefault();
	            var todo = {
	                description: _react2['default'].findDOMNode(this.refs.newTodo).value,
	                status: false
	            };

	            _actions2['default'].create(todo);

	            _react2['default'].findDOMNode(this.refs.newTodo).value = '';
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement('input', { className: "todo-input", name: "addDes", placeholder: "What need to be done?", type: "text", ref: 'newTodo' })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoStore = (function () {
	    function TodoStore() {
	        ...
	        this.bindListeners({
	            loadCompleted: _actions2['default'].loadCompleted,
	            deleteCompleted: _actions2['default'].deleteCompleted,
	            createCompleted: _actions2['default'].createCompleted,
	            updateCompleted: _actions2['default'].updateCompleted,
	            toggleDoneCompleted: _actions2['default'].toggleDoneCompleted,
	            isDoneCompleted: _actions2['default'].isDoneCompleted
	        });
	    ...
	    _createClass(TodoStore, [{
	        key: 'loadCompleted',
	        value: function loadCompleted(todos) {
	            var isAllDone = _underscore2['default'].reduce(todos, function (memo, todo) {
	        ...
	        key: 'createCompleted',
	        value: function createCompleted(todo) {
	            this.state.todos.push(todo);
	        }
	    }, {
	        key: 'updateCompleted',
	        value: function updateCompleted(todo) {
	            //let newIsAllChecked = this.state.isCheckedAll && !!todo.status;
	            var index = _underscore2['default'].findIndex(this.state.todos, function (item) {
	                return item.id == todo.id;
	            });
	            var todos = this.state.todos;
	            todos[index] = todo;

	            var newIsAllChecked = _underscore2['default'].reduce(todos, function (memo, todo) {
	                return memo && todo.status;
	            }, true);
	            this.setState({ todos: todos, isCheckedAll: newIsAllChecked });
	        }
	    }, {
	        key: 'toggleDoneCompleted',
	        value: function toggleDoneCompleted(allDone) {
	            var todos = this.state.todos;
	            todos.forEach(function (todo) {
	                return todo.status = allDone;
	            });
	            this.setState({ todos: todos, isCheckedAll: allDone });
	        }
	    }, {
	        key: 'isDoneCompleted',
	        value: function isDoneCompleted() {
	...
	exports['default'] = _alt2['default'].createStore(TodoStore, 'TodoStore');
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoActions = (function () {
	    function TodoActions() {
	        ...
	        this.generateActions('loadCompleted', 'updateCompleted', 'deleteCompleted', 'createCompleted', 'updateCompleted', 'toggleDoneCompleted', 'isDoneCompleted');
	    }
	    ...
	    _createClass(TodoActions, [{
	        ...
	        value: function load() {
	            ...
	            _superagent2['default'].get('/todoList').accept('json').end(function (err, res) {
	                if (!err) {
	                    _this.actions.loadCompleted(res.body);
	                }
	            });
	        }
	    }, {
	        ...
	        value: function update(todo) {
	            ...
	            _superagent2['default'].post('/todos/edit').send(todo).end(function (err, res) {
	                if (!err) {
	                    _this2.actions.updateCompleted(todo);
	                }
	            });
	        }
	    }, {
	        ...
	        value: function _delete(index) {
	            ...
	            _superagent2['default'].del('/todos/' + index).end(function (err, res) {
	                if (!err) {
	                    _this3.actions.deleteCompleted(index);
	                }
	            });
	        }
	    }, {
	        ...
	        value: function create(todo) {
	            ...
	            _superagent2['default'].post('/todos/new').send(todo).end(function (err, res) {
	                if (!err) {
	                    todo.id = res.body;
	                    _this4.actions.createCompleted(todo);
	                }
	            });
	        }
	    }, {
	        key: 'toggleDone',
	        value: function toggleDone(todos, allDone) {
	            var _this5 = this;

	            var callMeWhenAllIsDone = _underscore2['default'].after(todos.length, function () {
	                return _this5.actions.toggleDoneCompleted(allDone);
	            });
	            todos.forEach(function (todo) {
	                todo.status = allDone;
	                _superagent2['default'].post('/todos/edit').send(todo).end(function (err, res) {
	        ...
	        value: function isDone(todos) {
	            ...
	            todos.filter(function (todo) {
	                ...
	                _superagent2['default'].del('/todos/' + todo.id).end(function (err, res) {
	                    if (!err) {
	                        _this6.actions.isDoneCompleted(todos);
	                    }
	                });
	            });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoList = (function (_React$Component) {
	    ...
	    function TodoList(props) {
	        ...
	        _get(Object.getPrototypeOf(_TodoList.prototype), 'constructor', this).call(this, props);
	        this.state = {
	            filter: ALL
	        };
	    }
	    ...
	    _createClass(TodoList, [{
	        ...
	        value: function handleChange() {
	            var ckall = _react2['default'].findDOMNode(this.refs.checkall).checked;
	            _actions2['default'].toggleDone(this.props.todos, ckall);
	        }
	    }, {
	        key: 'setFilter',
	        ...
	        value: function handleSubmit(e) {
	            ...
	            _actions2['default'].isDone(this.props.todos);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                'div',
	                { className: "main" },
	                this.props.todos.length > 0 ? _react2['default'].createElement('input', { className: "toggle-all", type: "checkbox", checked: this.props.isCheckedAll, ref: "checkall",
	                    onChange: this.handleChange.bind(this) }) : _react2['default'].createElement('div', null),
	                _react2['default'].createElement(
	                    'ul',
	                    { className: "todoList" },
	                    todoItems
	                ),
	                this.props.todos.length > 0 ? _react2['default'].createElement(
	                    'div',
	                    { className: "footer" },
	                    _react2['default'].createElement(
	                        'span',
	                        { className: "todo-count" },
	                        todoItems.length + " item(s) left"
	                    ),
	                    _react2['default'].createElement(
	                        'ul',
	                        { className: "filter" },
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement(
	                                'a',
	                                { href: "#", onClick: this.setFilter.bind(this, ALL) },
	                                'All'
	                            )
	                        ),
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement(
	                                'a',
	                                { href: "#", onClick: this.setFilter.bind(this, ACTIVE) },
	                                'Active'
	                            )
	                        ),
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement(
	                                'a',
	                                { href: "#", onClick: this.setFilter.bind(this, COMPLETED) },
	                                'Completed'
	                            )
	                        ),
	                        _react2['default'].createElement(
	                            'button',
	                            { onClick: this.handleSubmit.bind(this), className: "clear-completed" },
	                            'Clear completed'
	                        )
	                    )
	    ...
	    TodoList = (0, _altUtilsConnectToStores2['default'])(TodoList) || TodoList;
	    return TodoList;
	})(_react2['default'].Component);
	    ...
	    _createClass(TodoItem, [{
	        ...
	        value: function handleSubmit(e) {
	            ...
	            var todo = {
	                ...
	                description: _react2['default'].findDOMNode(this.refs.todoitem).value,
	                status: this.props.todo.status
	            };
	            if (todo.description === '') {
	                _actions2['default']['delete'](todo.id);
	            } else {
	                _actions2['default'].update(todo);
	            }
	            this.setState({
	                edited: false
	            });
	        ...
	        value: function onChange() {
	            var todo = {
	                id: this.props.todo.id,
	                status: _react2['default'].findDOMNode(this.refs.todocheck).checked,
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                edited ? _react2['default'].createElement(
	                    'form',
	                    { onSubmit: this.handleSubmit.bind(this) },
	                    _react2['default'].createElement('input', { className: "edit-item", type: 'text', defaultValue: this.props.todo.description,
	                        ref: "todoitem"
	                    })
	                ) : _react2['default'].createElement(
	                    'div',
	                    { className: "view" },
	                    _react2['default'].createElement('input', { type: 'checkbox', className: "toggle", checked: this.props.todo.status,
	                        onChange: this.onChange.bind(this), ref: "todocheck" }),
	                    this.props.todo.status ? _react2['default'].createElement(
	                        'span',
	                        { className: "completed",
	                            onClick: function () {
	                                return _this.edit();
	                    ...
	                    _react2['default'].createElement(
	                        'a',
	                        { href: "#", onClick: _actions2['default']['delete'].bind(null, this.props.todo.id),
	                            className: "delete" },
	                        'x'
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escapeTextForBrowser = __webpack_require__(182);
